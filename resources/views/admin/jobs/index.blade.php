            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-6">
                    <div class="header-actions">
                        <a href="{{ route('admin.dashboard') }}" class="btn-outline-premium me-2">
                            <i class="bi bi-speedometer2 me-2"></i>
                            Dashboard
                        </a>
                        <a href="{{ route('admin.jobs.create') }}" class="btn-primary-premium">
                ...
                <div class="row g-4">
                    ...
                    <div class="col-lg-3">
                        <div class="filter-actions">
                            ...
                            <a href="{{ route('admin.jobs.index') }}" class="btn-reset">
        ...
        <div class="jobs-premium-card">
            <div class="card-header">
                ...
                <div class="table-actions">
                    ...
                    <a href="{{ route('admin.jobs.export', request()->query()) }}" class="btn-export">
                        <i class="bi bi-download me-2"></i>
                        Export
                    </a>
                    <a href="{{ route('admin.jobs.trash') }}" class="btn-trash">
                                ...
                                <tr class="job-row">
                                    ...
                                    <td class="text-end">
                                        <div class="action-buttons">
                                            ...
                                            <a href="{{ route('admin.jobs.edit', $job) }}" class="action-btn edit"
                                                title="Edit Job">
