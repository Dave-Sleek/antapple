    ...
    <div class="container-fluid py-5 px-4">
                    ...
                    <div class="d-flex align-items-center gap-4">
                        ...
                        <div>
                            <span class="badge bg-danger-subtle text-danger px-4 py-2 rounded-pill mb-2">
                                <i class="bi bi-recycle me-2"></i>ADMIN RECYCLE BIN
                            </span>
                ...
                <div class="row g-4">
                    ...
                    <div class="col-lg-3">
                        <div class="filter-actions">
                            ...
                            <a href="{{ route('admin.jobs.trash') }}" class="btn-reset">
                                <i class="bi bi-arrow-counterclockwise"></i>
                            </a>
                        </div>
                    </div>
                                    ...
                                    <tr class="job-row" data-deleted="{{ $job->deleted_at }}">
                                        ...
                                        <td class="text-end">
                                            <div class="action-buttons">
                                                ...
                                                {{-- Permanent Delete --}}
                                                <form method="POST"
                                                    action="{{ route('admin.jobs.forceDelete', $job->id) }}"
        ...
        @else
            ...
            <div class="empty-state-premium">
                ...
                <a href="{{ route('admin.jobs.index') }}" class="btn-browse mt-4">
            ...
            <div class="row align-items-center">
                <div class="col-md-8">
                    <div class="d-flex align-items-center gap-3">
                        ...
                        <div>
                            <h5 class="fw-bold mb-1">About Admin Trash</h5>
                            <p class="text-muted mb-0">As an admin, you can view all deleted jobs across the platform.
                ...
                <div class="col-md-4 text-md-end">
                    <span class="badge bg-light text-dark px-4 py-2 rounded-pill">
                        <i class="bi bi-shield me-2"></i>Admin Access Only
                    </span>
                </div>
            </div>
        </div>
