...
@section('content')
    <div class="container">
        ...
        <form method="POST" action="{{ route('editor-jobs.store') }}" enctype="multipart/form-data">
            @csrf
            ...
            <a href="{{ route('editor.dashboard') }}" class="btn btn-secondary ms-2">
                Cancel
            </a>
        </form>
    </div>
    @include('editor.jobs.preview-modal')
@endsection
<script>
